...
ActiveRecord::Schema.define(version: 20170929174908) do
  ...
  create_table "subads", force: :cascade do |t|
    t.string   "image"
    t.string   "title"
    t.text     "content"
    t.string   "brand"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "admin_column",           default: false
  end

  add_index "users", ["email"], name: "index_users_on_email", unique: true, using: :btree
  add_index "users", ["provider"], name: "index_users_on_provider", using: :btree
  add_index "users", ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true, using: :btree
  add_index "users", ["subscriptions_id"], name: "index_users_on_subscriptions_id", using: :btree
